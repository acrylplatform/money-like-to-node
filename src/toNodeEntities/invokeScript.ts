...
export const invokeScript = factory<IAcrylGuiInvokeScript, TWithPartialFee<IInvokeScriptTransaction<string>>>({
    ...getDefaultTransform(),
...
export interface IAcrylGuiInvokeScript extends IDefaultGuiTx<typeof TYPES.INVOKE_SCRIPT> {
    dApp: string;
